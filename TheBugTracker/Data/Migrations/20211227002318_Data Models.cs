        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageCotentType = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TickStatusId = table.Column<string>(type: "text", nullable: true),
                    OwnerUserId = table.Column<bool>(type: "boolean", nullable: false),
                    DeveloperUserId = table.Column<string>(type: "text", nullable: true),
                    TicketStatusId = table.Column<int>(type: "integer", nullable: true),
                    OwnerUserId1 = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tickets_AspNetUsers_OwnerUserId1",
